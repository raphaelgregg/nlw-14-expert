...
export function NewNoteCard({onNoteCreated}: NewNoteCardProps) {
  ...
  function handleSaveNote(event: FormEvent) {
    ...
    // retorna se tentar salvar content vazio
    if(content == '') {
      return
    }
    ...
    toast.success('Nota crianda com sucesso!')
  }
  ...
  function handleStartRecording() {
    ...
    // Mamtém gravação até requisição manual para parar 
    speechRecognition.continuous = true;
    // API retornar varias opções, configurando numero de alternativas retornadas
    speechRecognition.maxAlternatives = 1;
    // API de reconhecimento de fala retorna valores conforme captação e não apenas finalização
    speechRecognition.interimResults = true;

    // função é chamada toda vez que API de reconhecimento de fala ouvir algo 
